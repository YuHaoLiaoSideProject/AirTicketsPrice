// worker/spike/vapid.mjs — Spike S1：CF Workers（Web Crypto only）上實作 Web Push（VAPID + RFC 8291）
// ---------------------------------------------------------------------------------------------
...
// 驗證：node worker/spike/verify.mjs（全綠 = Spike 可行）
// ---------------------------------------------------------------------------------------------
